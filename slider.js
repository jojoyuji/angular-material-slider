...
(function() {
  var MODULE_NAME, SLIDER_TAG, angularize, contain, events, gap, halfWidth, hide, hsize, module, offset, offsetLeft, pixelize, qualifiedDirectiveDefinition, roundStep, show, sliderDirective, width;
      ...
      compile: function(element, attributes) {
        ...
        return {
          post: function(scope, element, attributes) {
            var activeBar, bar, barWidth, bound, ceilBub, dimensions, e, flrBub, handleHalfWidth, highBub, i, j, len, len1, lowBub, maxOffset, maxPtr, maxValue, minOffset, minPtr, minValue, ngDocument, offsetRange, ref1, ref2, selection, updateDOM, upper, valueRange, w;
            ref1 = (function() {
